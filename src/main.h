...
inline int GetPOSProtocolVersion(int nHeight) { return nHeight >= 2100000 ? 2 : 1; }
...
public:
    ...
    */
    ...
    bool ConnectInputs(CTxDB& txdb, MapPrevTx inputs,
                       ...
                       const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool *txAlreadyUsed=nullptr);
